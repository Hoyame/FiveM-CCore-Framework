    ...
    Citizen.CreateThread(function()
        if FirstSpawn then
            ...
            if charID == 1 then
                ...
                TriggerServerCallback('corazon_character:getPlayerSkinOne', function(skin)
                    if skin ~= nil then
                        DoScreenFadeIn(800)
                        RemoveLoadingPrompt()
            ...
            elseif charID == 2 then
                ...
                TriggerServerCallback('corazon_character:getPlayerSkinTwo', function(skin)
                    if skin ~= nil then
                        DoScreenFadeIn(800)
                        RemoveLoadingPrompt()
                        TriggerEvent('skinchanger:loadSkin', skin)	
