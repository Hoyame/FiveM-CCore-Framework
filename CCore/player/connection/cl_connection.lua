...
local cashOne, bankOne, metierOne, cashTwo, bankTwo, metierTwo
local nomOne = ""
local nomTwo = ""
...
function callBackSpawnPlayer(charID)
    local charID = charID
...
AddEventHandler('corazon_connexion:dataGripSelectPersoOne', function(result)
	...
	cashOne = tonumber(result[1].pCash)
	bankOne = tonumber(result[1].pBank)
...
AddEventHandler('corazon_connexion:dataGripSelectPersoTwo', function(result)
	...
	cashTwo = tonumber(result[1].pCash)
	bankTwo = tonumber(result[1].pBank)
...
local function selectPersoOne()
	...
	if nomOne == "nil" then 
		...
		DrawAdvancedText2(0.897000000000001, 0.320, 0.005, 0.0028, 0.300, translate('cash').." : "..cashOne, 255, 255, 255, 255, 0, 1)
		DrawAdvancedText2(0.897000000000001, 0.350, 0.005, 0.0028, 0.300, translate('bank').." : "..bankOne, 255, 255, 255, 255, 0, 1)
...
local function selectPersoTwo()
	...
	if nomTwo == "nil" then 
		...
		DrawAdvancedText2(0.897000000000001, 0.620, 0.005, 0.0028, 0.300, translate('cash').." : "..cashTwo, 255, 255, 255, 255, 0, 1)
		DrawAdvancedText2(0.897000000000001, 0.650, 0.005, 0.0028, 0.300, translate('bank').." : "..bankTwo, 255, 255, 255, 255, 0, 1)
